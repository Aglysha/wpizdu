...
?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
                            ...
                            <div class="col-4">
                                <div class="card text-center">
                                    <div class="card-body card-body--flex">
                                        ...
                                        <p class="card-text" style="font-size: 14px;text-transform: uppercase;">ЭКСПЕРТ РА 2019</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                ...
                <section class="section" style="background-image: url('<?=get_template_directory_uri()."/img/secondary.png"?>');">
                        ...
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col-6">
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-lg btn-primary" data-toggle="modal" data-target="#myModal">Получить консультацию</button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                                <div class="card">
                                    <img src="<?=get_template_directory_uri(). '/img/news/news_1.png'?>" class="card-img-top mb-2">
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <img src="<?=get_template_directory_uri(). '/img/news/news_2.png'?>" class="card-img-top mb-2">
                                    <p class="card-text">БИЗНЕС <br>
                                        12.12.2020 20:30</p>
                                    <h5 class="card-title">Сайт ВТБ Лизинг вошел в число лучших в Рунете</h5>
                                </div>
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <img src="<?=get_template_directory_uri(). '/img/news/news_3.png'?>" class="card-img-top mb-2">
                                    <p class="card-text">БИЗНЕС <br>
                                        12.12.2020 20:30</p>
                                    <h5 class="card-title">Сайт ВТБ Лизинг вошел в число лучших в Рунете</h5>
                                </div>
