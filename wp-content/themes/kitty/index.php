    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main">
            <section class="section"
                     style="background-image: url('<?= get_template_directory_uri() . "/img/primary.png"; ?>)">
                <div class="container">
                    ...
                    <div style="margin: 100px 0 350px;">
                        <p class="big_text mb-5" style="line-height: 48px;">Крупнейшая лизинговая <br> компания в России
                        </p>
                        ...
                        <button class="btn-lg btn-primary btn" data-toggle="modal" data-target="#myModal">Получить
                            консультацию
                        </button>
                    </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-4">
                            <div class="card text-center">
                                <div class="card-body card-body--flex">
                                    <img src="<?= get_template_directory_uri() . '/img/badges/top.png' ?>" width="82"
                                         height="100" alt="">
                                    <h5 class="card-title">Крупнейшая лизинговая<br> компания в России</h5>
                                    <p class="card-text" style="font-size: 12px;text-transform: uppercase;">
                                        III МЕЖДУНАРОДНАЯ ПРЕМИЯ<br>
                                        LEADER LEASING STAR AWARDS 2019</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="card text-center">
                                <div class="card-body card-body--flex">
                                    <img src="<?= get_template_directory_uri() . '/img/badges/diamond.png' ?>"
                                         width="82" height="100" alt="">
                                    <h5 class="card-title">По чистым инвестициям в лизинг</h5>
                                    <p class="card-text" style="font-size: 14px;text-transform: uppercase;">ЭКСПЕРТ РА
                                        2019</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="card text-center">
                                <div class="card-body card-body--flex">
                                    <img src="<?= get_template_directory_uri() . '/img/badges/leader.png' ?>" width="82"
                                         height="100" alt="">
                                    <h5 class="card-title">Лидер</h5>
                                    <p class="card-text" style="font-size: 14px;">по объему нового
                                        бизнеса в <br>сегменте оборудования для <br>нефтегазодобычи и переработки</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section"
                     style="background-image: url('<?= get_template_directory_uri() . "/img/secondary.png" ?>');">
                <div class="container text-white">
                    <div class="row" style="margin: 100px 0 200px;">
                        <div class="col-7">
                            <p class="big_text mb-5">ВТБ Лизинг</p>
                            <p class="small_text mb-5">
                                Является частью <br>
                                Корпоративно-Инвестиционного Бизнеса Группы <br>
                                ВТБ – лидера на рынке<br>
                            ...
                            <button class="btn-lg btn-primary btn">Смотреть видео</button>
                        </div>
                        <div class="col-5 d-flex justify-content-end">
                            <a class="video-link" href="#play-video">
                                <svg width="46" height="53" viewBox="0 0 46 53" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M46 26.5L0.250001 52.9138L0.250004 0.0862235L46 26.5Z" fill="white"/>
                                </svg>
                            </a>
                        </div>
                    </div>
            ...
            <section class="section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="card">
                                <img src="<?= get_template_directory_uri() . '/img/news/news_1.png' ?>"
                                     class="card-img-top mb-2">
                                <p class="card-text">БИЗНЕС <br>
                                    12.12.2020 20:30</p>
                                <h5 class="card-title">Сайт ВТБ Лизинг вошел в число лучших в Рунете</h5>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="card">
                                <img src="<?= get_template_directory_uri() . '/img/news/news_2.png' ?>"
                                     class="card-img-top mb-2">
                                <p class="card-text">БИЗНЕС <br>
                                    12.12.2020 20:30</p>
                                <h5 class="card-title">Сайт ВТБ Лизинг вошел в число лучших в Рунете</h5>
                        ...
                        <div class="col-3">
                            <div class="card">
                                <img src="<?= get_template_directory_uri() . '/img/news/news_3.png' ?>"
                                     class="card-img-top mb-2">
                                <p class="card-text">БИЗНЕС <br>
                                    12.12.2020 20:30</p>
                                <h5 class="card-title">Сайт ВТБ Лизинг вошел в число лучших в Рунете</h5>
